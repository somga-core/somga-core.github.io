...
function getGithubInfo(link) {
  ...
  return [image_link, splited_link[4], splited_link[3], source_link, source_link + "/archive/refs/heads/main.zip", "https://raw.githubusercontent.com/" + splited_link[3] + "/" + splited_link[4] + "/main/README.md"];
}

function loadProjectContent(info) {
  var html = loadFile("project_content.html").split("~");
