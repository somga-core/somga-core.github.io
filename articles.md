...
`<объект>` может быть цифрой от 1 до 9, означающим номер регистра. Или он может быть 0, означающим нулл

Так же `<объект>` может быть цифрой от 1 до 9, означающей количество четвёрок разрядов числа, которое будет указано после `<взаимодействия>`. Например `2130 0231` означает, что регистр 2 имеет красный канал цвета, величиной в число с одной четвёркой разрядов, разделённое на 255 (`2130`): 231 (`0255`)
